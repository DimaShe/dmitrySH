            ...
            stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
                ...
                public void handle(WindowEvent event) {
                    ...
                    if (socket != null && !socket.isClosed()) {
                        try {
                            out.writeUTF("/end");
                            client.HistoryHandler.closeWriting();
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
...
/////////////////
                    ...
                    textArea.appendText(client.HistoryHandler.readLastMessages());
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            ...
                            textArea.appendText(str + "\n");
                            client.HistoryHandler.appendText(str + "\n");
                        }
                    }
    ...
    public void tryToAuth(ActionEvent actionEvent) {
        ...
        try {
            ...
            client.HistoryHandler.setLogin(loginField.getText());
            loginField.clear();
            passwordField.clear();
        } catch (IOException e) {
            e.printStackTrace();
